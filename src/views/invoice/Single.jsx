...
import { addInvoiceToApartment, getAllApartments, getInvoice } from "../../services/endpoints";
                ...
                <div className="form-group">
                  <label className="row">
                    ...
                    <div className="col-sm-10">
                      <input type="text" className="form-control" id="period" onChange={(e) => { setPeriod(e.target.value) }} value={period} />
                    </div>
                  </label>
                </div>
                <div className="form-group">
                  <label className="row">
                    ...
                    <div className="col-sm-10">
                      <input type="text" className="form-control" id="amount" onChange={(e) => { setAmount(e.target.value) }} value={amount} />
                    </div>
                  </label>
                </div>
                <div className="form-group">
                  <label className="row">
                    ...
                    <div className="col-sm-10">
                      <input type="date" className="form-control" id="paymentDate" onChange={(e) => { setPaymentDate(e.target.value) }} value={paymentDate} />
                    </div>
                  </label>
                </div>
                <div className="form-group">
                  <label className="row">
                    ...
                    <div className="col-sm-10">
                      <select className="form-control" id="type" onChange={(e) => { setApartmentId(e.target.value) }} value={apartmentId}>
                        {apartments.map((item) =>
