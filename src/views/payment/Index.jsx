...
import { getCreditCardInfo, payInvoice } from "../../services/endpoints";
import { getInvoice } from "../../services/endpoints";
...
export default function Payment() {
  ...
  const handleSubmit = async () => {
    let response = await payInvoice(params.id, cardNo, expireYear, expireMonth, ccv)
  ...
  useEffect(() => {
    ...
    async function fetchCard() {
      let response = await getCreditCardInfo(params.id)
